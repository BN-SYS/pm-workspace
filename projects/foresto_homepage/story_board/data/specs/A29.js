...
<p>
  ...
  - [+ 연도 추가]: 연혁 등록/수정(A30) 화면으로 이동 (등록 모드)
</p>
...
<p>
  ...
  - 행 클릭: 해당 연도 수정 (연혁 등록/수정, A30, ?year= 전달)<br>
  - 내용 컬럼: 항목별 줄바꿈 표시 (text 말줄임 없이 전체 표시)
</p>

<h4>③ 행 내 관리 버튼</h4>
<p>
  - [수정]: A30로 이동 (?year= 전달)<br>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>3</td><td>연도</td><td>number</td><td>C</td><td>굵게 표시. 클릭 시 A30(수정) 이동</td></tr>
...
<table>
  ...
  <tbody>
    <tr><td>A30</td><td>연혁 등록/수정</td><td>[+ 연도 추가] 클릭 (등록)/행 클릭 또는 [수정] 클릭 (수정, ?year= 전달)</td></tr>
