...
window.ANNOTATIONS['A32'] = [
  { n: 1, x: 13, y:  7 },   // 상단 영역 ([+ 등록] 버튼)
  { n: 2, x: 13, y: 12 },   // 상태 필터 탭 (전체·노출중·종료)
  { n: 3, x: 13, y: 18 },   // 목록 테이블
  { n: 4, x: 45, y: 40 },   // 미리보기 오버레이 모달 (행 클릭 시 노출)
  { n: 5, x: 50, y: 82 },   // 페이지네이션
];
...
<table>
  ...
  <tbody>
    ...
    <tr><td>삭제 성공</td><td>Toast (error 스타일)</td><td>팝업이 삭제되었습니다.</td></tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr><td>A33</td><td>팝업 등록/수정</td><td>[+ 등록] 클릭(등록)/[수정] 클릭(수정, ?id= 전달)</td></tr>
  </tbody>
</table>
