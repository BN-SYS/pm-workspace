...
window.ANNOTATIONS['A33'] = [
  ...
  { n: 2, x: 13, y: 11 },   // 2열 레이아웃 (좌: 설정 / 우: 미리보기)
  { n: 3, x: 13, y: 16 },   // 기본 설정 카드 (팝업명·상태·노출기간)
  { n: 4, x: 13, y: 30 },   // 팝업 크기 및 위치 카드
  { n: 5, x: 13, y: 47 },   // 이미지 첨부 (선택)
  { n: 6, x: 13, y: 57 },   // 내용 (SmartEditor2)
  { n: 7, x: 13, y: 77 },   // 링크 URL (선택)
  { n: 8, x: 55, y: 11 },   // 라이브 프리뷰 패널 (우측)
  { n: 9, x: 88, y:  7 },   // 저장/취소 버튼
];
