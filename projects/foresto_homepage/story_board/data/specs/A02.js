...
window.ANNOTATIONS['A02'] = [
  { n: 1, x: 13, y:  7 },   // 페이지 타이틀
  { n: 2, x: 13, y: 12 },   // 관리 설정
  { n: 3, x: 13, y: 23 },   // 본인인증 기반 정보
  { n: 4, x: 13, y: 34 },   // 계정·연락처 정보
  { n: 5, x: 13, y: 62 },   // 교육 신청 내역
  { n: 6, x: 13, y: 71 },   // 활동 정보 (소속)
  { n: 7, x: 13, y: 78 },   // 관리자 메모
  { n: 8, x: 13, y: 86 },   // 회원 탈퇴 처리
  { n: 9, x: 88, y:  7 },   // 상단 우측 버튼 영역
];
