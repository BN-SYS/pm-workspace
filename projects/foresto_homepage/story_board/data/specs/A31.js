...
window.ANNOTATIONS['A31'] = [
  { n: 1, x: 13, y:  6 },   // 모드 구분 (등록/수정)
  { n: 2, x: 13, y: 12 },   // 2열 레이아웃 (좌: 설정 / 우: 미리보기)
  { n: 3, x: 13, y: 18 },   // 배너 이미지 (필수)
  { n: 4, x: 13, y: 44 },   // 텍스트 설정 (제목·설명)
  { n: 5, x: 13, y: 62 },   // 더보기 버튼 링크 (선택)
  { n: 6, x: 55, y: 14 },   // 라이브 프리뷰 패널 (우측)
  { n: 7, x: 88, y:  7 },   // 저장/취소 버튼
];
