...
<p>
  ...
  - [+ 등록]: 게시글 등록/수정(A27)으로 이동 (등록 모드, ?type= 전달)
</p>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>2</td><td>제목</td><td>text</td><td>C</td><td>클릭 시 A26 이동. 상단 고정 행은 [고정] 배지 함께 표시</td></tr>
...
<table>
  ...
  <tbody>
    <tr><td>A26</td><td>게시글 상세</td><td>목록 행 클릭 시 이동 (?type=&id= 전달)</td></tr>
    <tr><td>A27</td><td>게시글 등록/수정</td><td>[+ 등록] 클릭 시 이동 (?type= 전달)</td></tr>
  </tbody>
</table>
